...
class AdminController
{
    ...
    public function actionGetCollectionDetails()
    {
        ...
        $query = "/*".__FILE__.':'.__LINE__."*/ ".
            ...
            from v_payments p
                left join custom_price_lds c on p.id_service = c.id
            where p.id_user = '$id'
    ...
    public function actionSetPriceGroupStatus()
    {
        ...
        $query = "/*".__FILE__.':'.__LINE__."*/ ".
            "SELECT custom_price_set_status($uid, 'lds', '$id', $status)";
    ...
    public function actionDeletePriceItem()
    {
        ...
        $query = "/*".__FILE__.':'.__LINE__."*/ ".
            "SELECT custom_price_delete($uid, 'lds', '$id')";
        $result = dbHelper\DbHelper::selectRow($query);
        $response['code'] = 0;
    ...
    public function actionSetClientsDesc()
    {
        ...
        $query = "/*".__FILE__.':'.__LINE__."*/ ".
            "SELECT custom_price_set_clients_desc($uid, 'lds', '$id', '$text')";
        $result = dbHelper\DbHelper::selectRow($query);
        $response['code'] = 0;
    ...
    public function actionSetCommentItem()
    {
        ...
        $query = "/*".__FILE__.':'.__LINE__."*/ ".
            "SELECT custom_price_set_comment($uid, 'lds', '$id', '$text')";
        $result = dbHelper\DbHelper::selectRow($query);
        $response['code'] = 0;
    ...
    public function actionSetPrice()
    {
        ...
        $query = "/*".__FILE__.':'.__LINE__."*/ ".
            "SELECT custom_price_set_price($uid, 'lds', '$id', '$price')";
        $result = dbHelper\DbHelper::selectRow($query);
        $response['code'] = 0;
    ...
    public function actionSetDayStatus()
    {
        ...
        $query = "/*".__FILE__.':'.__LINE__."*/ ".
            "SELECT custom_price_set_dayoff($uid, 'lds', '$id', '$idDay', '$status')";
        $result = dbHelper\DbHelper::selectRow($query);
        $response['code'] = 0;
    ...
    public function actionSetNds()
    {
        ...
        $query = "/*".__FILE__.':'.__LINE__."*/ ".
            "SELECT custom_price_set_nds($uid, 'lds', '$id', '$nds')";
        $result = dbHelper\DbHelper::selectRow($query);
        $response['code'] = 0;
    ...
    public function actionSetBill()
    {
        ...
        $query = "/*".__FILE__.':'.__LINE__."*/ ".
            "SELECT custom_price_set_bill($uid, 'lds', '$id', '$status')";
        $result = dbHelper\DbHelper::selectRow($query);
        $response['code'] = 0;
    ...
    public function actionSetWorkTime()
    {
        ...
        $query = "/*".__FILE__.':'.__LINE__."*/ ".
            "SELECT custom_price_set_time($uid, 'lds', '$id', '$idDay',  $timeStart, $timeFinish)";
        $result = dbHelper\DbHelper::selectRow($query);
        $response['code'] = 0;
    ...
    public function actionSetColor()
    {
        ...
        $query = "/*".__FILE__.':'.__LINE__."*/ ".
            "SELECT custom_price_set_color($uid, 'lds', '$id', '$color')";
        $result = dbHelper\DbHelper::selectRow($query);
        $response['code'] = 0;
